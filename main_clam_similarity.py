...
import h5py
import openslide
from loss_func import ece_loss
...
def train_eval_clam(train_dataset, test_dataset):
    ...
    for epoch in range(1):
        ...
        print("Eval section: ")
        eval(epoch, model_clam, test_dataset, n_classes, bag_weight, logger, ece_loss)
...
def main(args):
    ...
    from src.pruning.similarity import importance_based_feature_selection
    ...
    train_dataset = PruningFeaturesDataset(
        ...
        pruning_function=importance_based_feature_selection,
        pruning_rate=0.5,
    )
    print("---")
